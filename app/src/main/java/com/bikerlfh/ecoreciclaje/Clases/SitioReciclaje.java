...
public class SitioReciclaje {
    ...
    public boolean insertSitioReciclaje(int idSitioReciclaje,String nombre,String direccion, String propietario,int idMunicipio,double latitud,double longitud){
